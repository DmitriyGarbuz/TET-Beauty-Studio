...
$form['form-main'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Контактная форма с сайта TET beauty studio',
		'title' => 'Информация для связи с клиентом',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@email.com',
		'from_name' => 'TET beauty studio',
		'to_email' => 'tet-a-tet2@ukr.net', 
		'to_name' => 'noreply',
		'geoip' => true,
		'referer' => false,
		'type' => 'html',
		...
		'okay' => 'Благодарим Вас, сообщение отправлено. Наш сотрудник свяжется с Вами в ближайшее время.',
		'fuck' => 'К сожалению отправить Ваше сообщение не удалось. Повторите снова',
		'spam' => 'не пытайтесь надуть нас, мы следим за вашими действиями !!!',
		'notify' => 'color-modal',
		'usepresuf' => false
	)
);
...
$form['enroll'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Записаться на курсы обучения',
...
$form['model'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Записаться в качестве модели',
    'title' => 'Направление',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
